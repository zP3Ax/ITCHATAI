...
.itc-topbar .itc-icon{ font-size:22px; color:var(--itc-text); }
.itc-topbar .itc-pill{
    flex:1; background:var(--itc-card); border:2px solid var(--itc-orange);
    border-radius:999px; padding:10px 20px; text-align:center;
    font-weight:600; color:var(--itc-text); font-size:15px;
}
...
.st-key-bottombar [data-testid="column"]:nth-of-type(3) button{
    border-radius:50% !important; width:48px; height:48px; min-width:48px;
    border:none !important; background:var(--itc-card) !important; color:var(--itc-text) !important;
    font-size:18px !important; box-shadow:0 2px 6px rgba(0,0,0,0.3);
}
...
.st-key-bottombar [data-testid="column"]:nth-of-type(2) input{
    ...
    background:var(--itc-card) !important; color:var(--itc-text) !important;
    padding:12px 18px 12px 42px !important;
    box-shadow:0 2px 8px rgba(0,0,0,0.3);
}
.st-key-bottombar [data-testid="column"]:nth-of-type(2) input::placeholder{
